        ...
        <div class="max-w-7xl mx-auto px-6 py-8 text-start md:px-0">
            ...
            <nav aria-label="Breadcrumb">
                <ol class="flex items-center text-sm md:text-base text-gray-600 gap-1 sm:gap-2">
                    <li>
                        <a href="{{ route('potensiDesa') }}" class="hover:text-custom font-medium">Potensi</a>
                                ...
                                <div class="flex-1">
                                    <h3
                                        ...
                                        <a href="#" class="focus:outline-none focus:ring-2 focus:ring-custom">
                                            ...
                                            adipisci qui fuga officia nihil incidunt sunt aliquam maiores! Architecto aut
                                            praesentium tenetur quis illo exercitationem quisquam soluta eos quibusdam.
                                        </a>
                                    </h3>
