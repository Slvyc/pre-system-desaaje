        ...
        <div class="max-w-7xl mx-auto px-6 py-8 text-start md:px-0">
            ...
            <nav aria-label="Breadcrumb">
                <ol class="flex items-center text-sm md:text-base text-gray-600 gap-1 sm:gap-2">
                    <li>
                        <a href="{{ route('potensi') }}" class="hover:text-custom font-medium">Potensi</a>
        ...
        <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-4">
            ...
            <article class="lg:col-span-3 bg-white rounded-0 md:rounded-3xl p-6">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center text-gray-500 text-sm gap-3 sm:gap-4 mb-12">
                    <div class="flex flex-wrap items-center gap-3 sm:gap-4">
                        ...
                        <time datetime="2025-09-21"
                            ...
                            {{ \Carbon\Carbon::parse($potensi->tanggal_potensi)->locale('id')->translatedFormat('l, d F Y') }}
                        </time>
                    ...
                    <span class="sm:ml-auto inline-flex items-center gap-1 text-sm text-gray-600"
                        ...
                        <span>Dilihat {{ $potensi->views }} kali</span>
                    </span>
                </div>
                ...
                <p class="text-gray-700 leading-relaxed mb-4">
                    {!! nl2br(e($potensi->bagian_potensi)) !!}
                </p>
            </article>
                        ...
                        <li>
                            <article class="flex items-start gap-4 group">
                                ...
                                <div class="w-20 h-16 flex-shrink-0 overflow-hidden rounded-lg">
                                    <img src="{{ asset('storage/' . $preview->gambar_potensi) }}" alt="{{ $preview->slug }}"
                                ...
                                <div class="flex-1">
                                    <h3
                                        ...
                                        <a href="{{ route('potensi.show', $preview->slug) }}" class="focus:outline-none focus:ring-2 focus:ring-custom">
                                            {{ $preview->nama_potensi }}
                                        </a>
                                    </h3>
